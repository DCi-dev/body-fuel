  ...
  return (
    <footer className="bg-zinc-200 dark:bg-zinc-800">
      <div className="mx-auto max-w-7xl overflow-hidden py-12 px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-8 flex justify-center space-x-6">
          {navigation.social.map((item) => (
            <a
              key={item.name}
              href={item.href}
              className="text-zinc-600 hover:text-zinc-600 dark:text-zinc-400 dark:hover:text-zinc-100"
            >
        ...
        <Link href="https://cdi.dev">
          <p className="mt-8 text-center text-lg text-zinc-600 hover:text-zinc-800 dark:text-zinc-400 dark:hover:text-zinc-300">
            &copy; 2023 CDi
          </p>
        </Link>
      </div>
