...
const recipes = [
  {
    title: "Cereals with milk and berries",
    href: "#",
    category: { name: "Breakfast", href: "#" },
    description:
  ...
  {
    title: "Mega sandwich with cheese and ham",
    href: "#",
    category: { name: "Lunch", href: "#" },
    description:
  ...
  {
    title: "Pizza with pepperoni and olives",
    href: "#",
    category: { name: "Dinner", href: "#" },
    description:
